...
from ScrapAndPreProcess.src.scraper.scraper_module import *
from ScrapAndPreProcess.src.preprocess.preprocess_module import *
import ScrapAndPreProcess.src.settings as settings
from ScrapAndPreProcess.src.db.database import connect_to_db, get_max_date
...
def main():
    ...
    check_and_fix_eponymo(downloadedDir)
...
#     # Example usage:
#     split_csv(
#         input_path="C:/sxoli/cleaned_output-2025-05-03-76773.csv",
